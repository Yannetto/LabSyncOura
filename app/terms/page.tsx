      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="prose prose-gray max-w-none space-y-6">
          ...
          <section>
            ...
            <p className="text-gray-700">
              <strong>This is an early-stage, experimental product.</strong> The service and its reports 
              may contain inaccuracies and are subject to change. Users should proceed with caution and 
              understand this is not a finalized product. The accuracy and completeness of data processing 
              are not guaranteed. Errors may occur. This service provides a formatting utility to generate 
              lab-style reports from your Oura ring data. It is a data visualization and summarization 
              tool only. The service is provided "as is" without warranties of any kind, and may contain 
              errors, inaccuracies, or incomplete information.
            </p>
            <p className="text-gray-700 mt-2">
              <strong>AI and Automated Processing:</strong> Parts of this service may rely on AI-assisted 
              formatting or summarization. These outputs are not reviewed by medical professionals and 
              may include interpretation errors. All calculations, formatting, and data presentation are 
          ...
          <section>
            ...
            <p className="text-gray-700 mt-2">
              <strong>The creators expressly disclaim any liability for health-related decisions made 
              using this service. Use of this tool is entirely at your own risk.</strong>
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mt-2">
              ...
              <li><strong>Present reports generated by this service as medical documentation in any clinical, 
              insurance, or legal context</strong></li>
            </ul>
          </section>
